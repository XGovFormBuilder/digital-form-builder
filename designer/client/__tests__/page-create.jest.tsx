...
describe("page create", () => {
  describe("Page create fields", () => {
    ...
    beforeEach(() => {
      ...
      getByText = render(<PageCreate {...props} />).getByText;
    });

    test("display page type", () => {
      const text = "Page type";
      expect(getByText(text)).toBeInTheDocument();
    });

    test("display page type help text", () => {
      const text =
    ...
    test("display link from title", () => {
      const text = "Page type";
      expect(getByText(text)).toBeInTheDocument();
    });

    test("display link from help text", () => {
      const text = "Add a link to this page from a different page in the form.";
      expect(getByText(text)).toBeInTheDocument();
    });

    test("display page title's title", () => {
      const text = "Page title";
      expect(getByText(text)).toBeInTheDocument();
    });

    test("display path title", () => {
      const text = "Path";
      expect(getByText(text)).toBeInTheDocument();
    });

    test("display path help text", () => {
      const text =
    ...
    test("display section option title", () => {
      const text = "Section (optional)";
      expect(getByText(text)).toBeInTheDocument();
    });

    test("display section option help text", () => {
      const text =
