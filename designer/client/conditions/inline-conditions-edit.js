...
class InlineConditionsEdit extends React.Component {
  ...
  render () {
    const { conditions, condition, editingIndex, editingError, selectedConditions } = this.state
  ...
  saveCondition = (condition) => {
    this.setState({
      conditions: this.state.conditions.replace(this.state.editingIndex, condition),
      condition: undefined,
      editingIndex: undefined
    })
  }
