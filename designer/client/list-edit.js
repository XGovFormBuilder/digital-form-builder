    ...
    return (
      <form onSubmit={(e) => this.onSubmit(e)} autoComplete="off">
        ...
        <div className="govuk-form-group">
          <label className="govuk-label govuk-label--s" htmlFor="list-title">
            Title
          </label>
          <input
        ...
        <div className="govuk-form-group">
          <label className="govuk-label govuk-label--s" htmlFor="list-name">
            Name
          </label>
          <span className="govuk-hint">
            This is used as the key in the JSON output. Use `camelCasing` e.g.
            animalTypes or countryNames
          </span>
          <input
            className="govuk-input govuk-input--width-20"
            id="list-name"
        ...
        <div className="govuk-form-group">
          <label className="govuk-label govuk-label--s" htmlFor="list-type">
            Value type
          </label>
          <select
