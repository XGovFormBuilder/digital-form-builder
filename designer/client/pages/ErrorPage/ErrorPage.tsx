...
export function ErrorPage({ history, location }: Props): ReactElement {
  ...
  return (
    <div className="error-summary">
      <BackLink onClick={goBack}>{i18n("Back to previous page")}</BackLink>
      ...
      <p className="govuk-body">
        We saved the last valid version of your form. Return to the designer to
        continue.
      </p>
      <p className="govuk-body">
      ...
      <ul className="govuk-list govuk-list--bullet govuk-list--spaced">
        ...
        <li>
          ...
          with details of what you were doing when this error occurred and your
