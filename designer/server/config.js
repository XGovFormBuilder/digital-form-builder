...
const schema = {
  ...
  persistentBackend: joi.string().valid('s3', 'file', 'azure'),
  s3Bucket: joi.string(),
  persistentKeyId: joi.string(),
  persistentAccessKey: joi.string(),
...
const config = {
  ...
  persistentBackend: process.env.PERSISTENT_BACKEND || 's3',
