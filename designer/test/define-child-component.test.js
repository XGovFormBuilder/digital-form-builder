...
suite('Define child component', () => {
  ...
  test('Selecting a component type should display the ComponentTypeEdit component', async () => {
    const wrapper = shallow(<DefineChildComponent data={data} page={page} saveCallback={saveCallback} cancelCallback={cancelCallback} EditComponentView={ComponentTypeEdit}/>)
  ...
  test('Should display the supplied EditComponentView component when initialised with a component', async () => {
    const component = { type: 'TextField', name: 'badger', hint: 'My hint' }
    const wrapper = shallow(<DefineChildComponent data={data} page={page} saveCallback={saveCallback} cancelCallback={cancelCallback} component={component} EditComponentView={ComponentTypeEdit}/>)
    await wrapper.instance().componentDidMount()
